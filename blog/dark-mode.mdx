...
For the result, click on the sun or moon in the top right of this page.
...
<div className="flex items-center"><span className="mr-2">Press me to test me!</span><FaArrowRight className="mr-2" /><DarkModeToggle /></div>
